"""Idempotently register the fake-safe governed social publishing Tool contracts."""
...
async def run() -> None:
    ...
    if settings.app_env not in {"development", "test"}:
        raise SystemExit("Social Tool bootstrap is forbidden outside development/test")
    try:
