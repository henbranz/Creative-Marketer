...
agent_runs = Table(
    ...
    Column("input_context_kind", String(64), nullable=False),
    Column("input_context_schema_version", Integer, nullable=False),
    Column("input_context_digest", String(71), nullable=False),
    Column("input_context_refs", JSONB, nullable=False),
